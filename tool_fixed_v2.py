...
_joined_1 = '\n'.join(results
                       f"{security_status}\n<pre>{clean_ansi_codes(_joined_1))}</pre>"
        send_to_telegram(telegram_msg)
    except Exception as e:
        console.print(f"[red]Error: {str(e)}[/red]")
